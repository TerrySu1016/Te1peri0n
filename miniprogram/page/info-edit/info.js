...
Page({
  ...
  data: {
    ...
    edu: [["UC Berkeley", "", "Aug 2022 - May 2026", "Activities and societies: CS61A, CS61B, DATA8, MATH 54，DATA100, MATH53, UGBA102A,INDENG120"], ["UC Berkeley", "BA Data Science", "Aug 2022 - May 2026", "Activities and societies: CS61A, CS61B, DATA8, MATH 54，DATA100, MATH53, UGBA102A,INDENG120"], ["UC Berkeley", "BA Data Science", "Aug 2022 - May 2026", "Activities and societies: CS61A, CS61B, DATA8, MATH 54，DATA100, MATH53, UGBA102A,INDENG120"]]
  },
  ...
  changeExp() {
    const user = this.data.profile['username']
    wx.navigateTo({
      url: `/page/modify/modify?data=exp&user=${user}`,
    })
  },
  ...
  changeEdu() {
    const user = this.data.profile['username']
    wx.navigateTo({
      url: `/page/modify/modify?data=edu&user=${user}`,
    })
  },
